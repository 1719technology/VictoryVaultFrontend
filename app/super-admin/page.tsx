...
//           fetch(`${API_BASE}/api/v1/admin/users`).then(res => res.json()),
//           fetch(`${API_BASE}/api/v1/all_campaign`).then(res => res.json()),
//         ])
    ...
    const fetchData = async () => {
      try {
        const [usersRes, campaignsRes, activityRes] = await Promise.all([
          fetch(`${API_BASE}/api/v1/admin/users`).then(res => res.json()),
          fetch(`${API_BASE}/api/v1/all_campaign`).then(res => res.json()),
          fetch(`${API_BASE}/admin/audit-logs`).then(res => res.json()),
        ])
