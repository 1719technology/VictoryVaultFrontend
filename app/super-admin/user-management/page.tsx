...
// Map backend role keys to friendly labels
...
export default function UserManagementPage() {
  ...
  const fetchSingleUser = async (userId: string) => {
    ...
    try {
      ...
      try {
        ...
        console.error("[fetchSingleUser] Failed to parse JSON:", jsonErr);
        throw new Error(`Invalid JSON from ${API}/api/v1/admin/users/${userId}`);
      }
  ...
  // Filter safely (avoid crash if users isn't array)
