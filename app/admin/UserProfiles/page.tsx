        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          <div className="mb-8 border-b border-gray-200 flex space-x-8">
            ...
            <button
              ...
              className={`py-2 px-1 border-b-2 font-medium text-sm ${activeTab === "campaign"
                  ? "border-red-500 text-red-600"
                  : "border-transparent text-gray-500 hover:text-gray-700"
                }`}
            >
          ...
          {activeTab === "profile" && profileData && (
            <form onSubmit={handleProfileSubmit} className="space-y-8">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input value={profileData.firstName} onChange={(e) => updateProfileField("firstName", e.target.value)} />
                    </div>
                    <div>
                      <Label>Last Name</Label>
                      <Input value={profileData.lastName} onChange={(e) => updateProfileField("lastName", e.target.value)} />
                    </div>
                  </div>

                  <div>
                    <Label>Email</Label>
                    <Input type="email" value={profileData.email} onChange={(e) => updateProfileField("email", e.target.value)} />
                  </div>

                  <div>
                    <Label>Phone</Label>
                    <Input type="tel" value={profileData.phone} onChange={(e) => updateProfileField("phone", e.target.value)} />
                  </div>

                  <div>
                    <Label>Date of Birth</Label>
                    <Input type="date" value={profileData.dateOfBirth} onChange={(e) => updateProfileField("dateOfBirth", e.target.value)} />
                  </div>
                </CardContent>
              </Card>
              ...
              <Card className="border-green-100">
                ...
                <CardContent className="space-y-6">
                  <div>
                    ...
                    <Input value={profileData.street} onChange={(e) => updateProfileField("street", e.target.value)} />
                  </div>
              ...
              {/* Banking Info (Commented bank name and account type) */}
              <Card className="border-purple-100">
                ...
                {showBankInfo && (
                  <CardContent className="space-y-6">
                    ...
                    <Input value={profileData.bankName} onChange={(e) => updateProfileField("bankName", e.target.value)} />
                  </div>
                  <div>
                    ...
                    <div>
                      ...
                      <Input value={profileData.routingNumber} onChange={(e) => updateProfileField("routingNumber", e.target.value)} />
                    </div>
                    <div>
